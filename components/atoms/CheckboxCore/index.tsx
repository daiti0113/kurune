...
export const CheckboxCore = forwardRef<HTMLInputElement, CheckboxCoreProps>(function CheckboxCoreInner({label, ...props}, ref) {
    return (
        <div className="flex items-center mb-4">
            <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 accent-primary-500 text-primary-600 bg-gray-100 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600" {...props} ref={ref} />
